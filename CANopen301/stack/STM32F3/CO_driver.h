...
#define CO_CAN_TXMAILBOX0   ((uint8_t)0x00)
#define CO_CAN_TXMAILBOX1   ((uint8_t)0x01)
#define CO_CAN_TXMAILBOX2   ((uint8_t)0x02)
...
typedef struct{
    /*CAN_TypeDef        *CANbaseAddress;          STM32F4xx specific */
		CAN_HandleTypeDef 		*CANbaseAddress;			//F302RB 
    CO_CANrx_t         *rxArray;
    uint16_t            rxSize;
    CO_CANtx_t         *txArray;
    uint16_t            txSize;
